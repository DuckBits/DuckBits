...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DuckBits " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"sven65.zapto.org/duck", "sven65.zapto.org/duck/dnsseed"},
    {"sven65.zapto.org/duck/pool", "sven65.zapto.org/duck/dnsseed"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DuckBits is probably already running."), addrBind.ToString().c_str());
        else
